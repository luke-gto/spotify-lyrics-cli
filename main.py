...
def load_credentials():
    ...
    if os.path.isfile(script_directory + '/.env'):
            ...
            if SPOTIPY_CLIENT_ID and SPOTIPY_CLIENT_SECRET and SPOTIPY_REDIRECT_URI != "":
                ...
                return SPOTIPY_CLIENT_ID, SPOTIPY_CLIENT_SECRET, SPOTIPY_REDIRECT_URI, GENIUS_TOKEN
...
if __name__ == '__main__':
    ...
    if data == None:
        ...
        user_input = input("Do you want to get the lyrics of your last played song: {} by {} ? Y/N\n".format(data[0], data[1]))
